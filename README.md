...
Была успешно пройдена предзащита выпускной работы.

**11.05.23**

Удалось немного улучшить результаты для трансформеров в регрессии при использовании предварительного биннинга за счет подбора гиперпараметров, однако в целом результаты по прежнему хуже остальных моделей.

**17.05.23**

Внесены заключительные правки в текст работы.

**19.05.23**

Финальный вариант текста работы выложен в репозитории.
